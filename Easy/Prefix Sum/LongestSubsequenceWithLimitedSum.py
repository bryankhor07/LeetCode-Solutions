...
# We sort the list nums in O(nlogn) time and perform binary search for each query in O(qlogn) time.
# Space Complexity: O(n). We use a list of size n to store the prefix sums.